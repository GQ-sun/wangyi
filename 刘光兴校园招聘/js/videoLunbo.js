$(function() {
	...
	//顺便改变小圆点样式
	function changeDotStyle(click) {
		if(click == 5) {
			$('.banner4_Ul li').eq(0).addClass('blackLi').siblings().removeClass('blackLi');
		} else {
			$('.banner4_Ul li').eq(click).addClass('blackLi').siblings().removeClass('blackLi');
		}
	}
	//视频小圆点点击事件
	$('.banner4_Ul li').click(function() {
